...
public extension AnyCodable {
    var jsonString: String? {
        ...
        return encodedMetadata.flatMap { String(data: $0, encoding: .utf8) }
    }
}

public extension AnyCodable {
    func decodedAs<T: Decodable>(_ type: T.Type) -> T? {
        guard let data = jsonString.flatMap({ $0.data(using: .utf8) }) else {
            return nil
        }
